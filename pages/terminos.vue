    ...
    <div class="row">
      ...
      <div class="col-md-12 mt-6">
        <div class="container">
          ...
          <p>
            Será requisito que nuestros Términos y Condiciones sean aceptados
          ...
          <p>
            ...
            entenderán incorporados en las interacciones y/o comunicaciones que
            se lleven a cabo mediante los sistemas comprendidos en el sitio
            theraj.cl entre los usuarios de este sitio y THE RAJ.
          </p>
          <p>&nbsp;</p>
          <ol start="2">
          ...
          <p>&nbsp;</p>
          <p>
            El cliente y/o consumidor podrá ejercitar en cualquier momento sus
            derechos de acceso, rectificación, cancelación y oposición al
            tratamiento de sus datos personales, mediante solicitud por escrito
          ...
          <p>
            ...
            la información registrada en el sitio, o bien, ante cualquier
            irregularidad en las interacciones o comunicaciones en el uso del
            sitio mencionado, como medida de protección a la identidad, nuestros
            ejecutivos podrán contactar al cliente y/o consumidor por vía
          ...
          <p>
            ...
            la ley lo permita, y solo a empresas relacionadas con THE RAJ en los
            términos que define el artículo 100 de la Ley Nº 18.045, con fines
            exclusivamente.
          </p>
          <ol start="6">
            <li><strong> PRECIOS INFORMADOS EN ESTE SITIO</strong></li>
          </ol>
          <p>
          ...
          <p>
            Las promociones que se ofrezcan en el sitio theraj.cl, no serán
          ...
          <p>
            ...
            licencias o patentes referidas. Lo anterior, sin perjuicio de las
          ...
          <p>
            Cuando el cliente y/o consumidor acepte estos Términos y
            Condiciones, el uso que efectúen del sitio theraj.cl será bajo su
            propio riesgo.
          </p>
          <p>&nbsp;</p>
          <p>
            ...
            en la transmisión, virus computacionales, fallas en las líneas de
            comunicación, robo, destrucción o acceso no autorizado a este sitio
          ...
          <ol start="11">
            <li>
              <strong> MODIFICACIONES DE TÉRMINOS Y CONDICIONES</strong>
            </li>
          </ol>
          <p>
          ...
          <p>
            Todo lo relativo a la interpretación y cumplimiento de los presentes
            Términos y Condiciones estará regido exclusivamente por las leyes de
          ...
          <p>
            En el caso que un cliente y/o consumidor tenga alguna duda, consulta
            o inquietud acerca del contenido de estos Términos y Condiciones,
            podrá enviar un mensaje de correo electrónico a la siguiente
            dirección: info@theraj.cl
          </p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h2 style="text-align: center">LEGALES</h2>
        </div>
        ;
      </div>
    </div>
